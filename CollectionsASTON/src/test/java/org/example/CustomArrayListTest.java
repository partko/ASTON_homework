...
import static org.example.CustomArrayList.bubbleSort;
...
public class CustomArrayListTest {
    ...
    void bubbleSort_emptyArray() {
        CustomArrayList<Integer> test = new CustomArrayList<>(Arrays.asList(emptyArray));
        bubbleSort(test);
    ...
    void bubbleSort_arrayOneElement() {
        CustomArrayList<Integer> test = new CustomArrayList<>(Arrays.asList(arrayOneElement));
        bubbleSort(test);
    ...
    void bubbleSort_evenArray() {
        CustomArrayList<Integer> test = new CustomArrayList<>(Arrays.asList(evenArray));
        bubbleSort(test);
    ...
    void bubbleSort_oddArray() {
        CustomArrayList<Integer> test = new CustomArrayList<>(Arrays.asList(oddArray));
        bubbleSort(test);
    ...
    void bubbleSort_arrayWithDuplicateElements() {
        CustomArrayList<Integer> test = new CustomArrayList<>(Arrays.asList(arrayWithDuplicateElements));
        bubbleSort(test);
    ...
    void bubbleSort_bigArray() {
        CustomArrayList<Integer> test = new CustomArrayList<>(Arrays.asList(bigArray));
        bubbleSort(test);
    ...
    void bubbleSort_withComparator() {
        CustomArrayList<Person> test = new CustomArrayList<>(Arrays.asList(
                new Person("Alice", 22),
                new Person("Kate", 18),
                new Person("Emily", 25)));
